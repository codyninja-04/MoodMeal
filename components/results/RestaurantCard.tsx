...
// Tapping anywhere opens Google Maps for directions to that place.
export function RestaurantCard({ restaurant }: RestaurantCardProps) {
  ...
  return (
    <a
      ...
      className="flex items-center justify-between gap-3 rounded-2xl border border-zinc-200 bg-white p-4 transition-colors hover:border-zinc-300 dark:border-zinc-800 dark:bg-surface dark:hover:border-zinc-700"
    >
